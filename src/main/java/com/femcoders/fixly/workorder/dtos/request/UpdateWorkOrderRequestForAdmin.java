...
public record UpdateWorkOrderRequestForAdmin(
        ...
        @Schema(description = "List of technician IDs to assign. Only SUPERVISOR and ADMIN can update this field.") List<Long> technicianIds,

        @Schema(description = "Supervisor ID to assign. Only ADMIN can update this field.") Long supervisorId) implements UpdateWorkOrderRequest {
}
